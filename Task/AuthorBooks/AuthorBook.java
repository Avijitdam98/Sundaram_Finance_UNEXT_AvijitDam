...
public class AuthorBook {
    public static void main(String[] args) {
        ...
        System.out.println(bookImpl.titlesOf(Java1, Java2, Java3));
        System.out.println(bookImpl.firstNameOfAuthors(joshuaBloch, brianGoetz, barryBurd));
    }
}